/*
  # Make document details fields optional
  
  1. Changes
    - Make all fields in student_document_details table optional
    - Drop existing constraints
    - Add new constraint for license fields
...
-- Recreate the table with optional fields
